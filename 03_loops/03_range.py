...
print("\nEjercicio 6:")
try:
  numero = int(input('introduzca un numero entero paara multimplicar: '))
  for i in range(1, 11):
    print(f'{numero} x {i} = {numero * i}')
except:
  print('se le pidio un NUMERO, corrija y vuelva a intentar por favor')