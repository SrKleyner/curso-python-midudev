...
numero_save = numeros[0]
numeros[0] = numeros[-1]
numeros[-1] = numero_save
...
# Ejemplo: 
lista = [10, 20, 30, 40, 50, 25, 33, 200, 99]
...
lenLista = int(len(lista)/2)
invertir = lista[0:lenLista]
invertir = invertir[::-1]
lista = invertir + lista[lenLista:]
print(lista)
#print(invertir)
